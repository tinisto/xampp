...
<style>
    ...
    /* Hide pagination numbers like main page */
...
<div class="news-container">
    ...
    $postsPerPage = 20; // Show more posts
    ...
    // Fetch posts with pagination - use correct field names
    ...
    if (mysqli_num_rows($resultPosts) > 0): ?>
        <div class="news-grid">
            <?php while ($post = mysqli_fetch_assoc($resultPosts)): 
                ...
                // Handle multiple image fields like main news page
                $image = '';
                $hasImage = false;
        ...
        <div class="pagination-container">
            <?php 
            $baseUrl = "/news/{$urlCategory}"; // Updated URL structure
