...
$query =
    "SELECT COUNT(*) AS pending_count FROM news WHERE approved IS NULL OR approved != 1;";
...
<div class="col d-flex">
    <div class="card <?php echo $cardClass; ?> rounded-lg shadow p-4 w-100 d-flex flex-column justify-content-center align-items-center">
        <h5 class="card-title text-xl font-weight-bold text-dark">Approve new News</h5>
        <div class="mt-auto">
            <?php renderButton(
                $buttonTitle,
                "pages/dashboard/news-dashboard/news-approve/news-approve.php",
                "sm",
                $buttonColor
            ); ?>
        </div>
