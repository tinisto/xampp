...
$tableName = 'universities'; // Or make it dynamic based on your use case
...
$result = fetchPaginatedResults(
    ...
    $connection,
    $tableName,
    "id_vpo"  // or your desired sorting column
);
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td class="text-center"><i class="fas fa-trash" style="color: red; cursor: pointer;"></i>';
        echo "</td>";
