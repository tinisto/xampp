...
// Check if 'id_vpo' parameter is present in the URL
if (isset($_GET["id_vpo"])) {
  ...
  $resultUniversities = $connection->query(
    "SELECT * FROM vpo WHERE id_vpo = $id_vpo"
  );
...
<div class="container mt-4">
  <div class="row justify-content-center">
    <form action="admin-approve-vpo-edit-form-process.php" method="post">
      ...
      <div class="d-flex justify-content-center align-items-center mt-3 gap-3">
        <div class="form-check">
          ...
          <label class="form-check-label text-white" for="approveVPO">Approve</label>
        </div>

        <input type="hidden" name="id_vpo" value="<?= $row['id_vpo']; ?>">
...
<script>
  document.getElementById("approveVPO").addEventListener("change", function() {
