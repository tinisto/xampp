<form id="demo-form" action="/pages/registration/registration_process.php" method="post" enctype="multipart/form-data">
    ...
    <div class="input-group mb-3">
        ...
        <span class="input-group-text password-toggle" id="showPassword">
    ...
    <div class="input-group mb-3">
        ...
        <span class="input-group-text password-toggle" id="showConfirmPassword">
            <i class="fas fa-eye"></i>
        </span>
    </div>
    <span id="passwordCriteria" class="form-text text-muted mb-3 d-block">Пароль должен содержать минимум 8 символов и включать буквы и цифры.</span>
