<?php
// Standalone category page with correct database host
error_reporting(E_ALL);
ini_set('display_errors', 1);

// Use the correct database host (not localhost)
$connection = new mysqli('u2709849.ipage.com', 'u2709849_default', 'JWBr0F_0', 'u2709849_default');
if ($connection->connect_error) {
    // Try alternative hosts
    $connection = new mysqli('127.0.0.1', 'u2709849_default', 'JWBr0F_0', 'u2709849_default');
    if ($connection->connect_error) {
        // Try with socket
        $connection = new mysqli('localhost:/tmp/mysql.sock', 'u2709849_default', 'JWBr0F_0', 'u2709849_default');
        if ($connection->connect_error) {
            die("Connection failed: " . $connection->connect_error . "<br>Please check database host configuration.");
        }
    }
}
