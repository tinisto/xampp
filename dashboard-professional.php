<?php
// Ultra-simple professional admin dashboard
session_start();
                ...
                <div class="actions-grid">
                    <div class="action-card">
                        ...
                        <div class="action-buttons">
                            <a href="/dashboard/users" class="btn btn-primary">Все пользователи</a>
                        </div>
                    </div>

                    <div class="action-card">
                        <div class="action-title">📰 Управление контентом</div>
                        <div class="action-description">
                            Создавайте новости и посты с богатым форматированием текста.
                        </div>
                        <div class="action-buttons">
