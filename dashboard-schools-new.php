...
<div style="padding: 20px;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <div style="display: flex; gap: 20px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="/dashboard/schools/new" class="action-btn primary">
                ...
                <tr style="border-bottom: 1px solid #dee2e6;">
                    ...
                    <td style="padding: 15px;">
                        <div style="display: flex; gap: 10px; justify-content: center;">
                            <a href="/dashboard/schools/edit/<?= $school['id_school'] ?>" 
...
function deleteSchool(schoolId) {
    if (confirm('Вы уверены, что хотите удалить эту школу?')) {
        ...
        window.location.href = '/dashboard/schools/delete/' + schoolId;
    }
}
</script>
