    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="content">
            ...
            <div class="type-selector">
                <a href="/admin/content/create.php?type=news" class="type-btn <?= $contentType === 'news' ? 'active' : '' ?>">
                    📰 Создать новость
                </a>
                <a href="/admin/content/create.php?type=post" class="type-btn <?= $contentType === 'post' ? 'active' : '' ?>">
                    📝 Создать пост
                </a>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="form-card-body">
                    <form action="/admin/create-process.php" method="POST" enctype="multipart/form-data" id="contentForm">
                        <?= csrfField() ?>
