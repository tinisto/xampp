...
<div style="padding: 20px;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <div style="display: flex; gap: 20px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="/admin/content/create.php?type=post" class="action-btn primary">
                ...
                <tr style="border-bottom: 1px solid #dee2e6;">
                    ...
                    <td style="padding: 15px;">
                        <div style="display: flex; gap: 10px; justify-content: center;">
                            <a href="/admin/content/edit.php?type=post&id=<?= $post['id_post'] ?>" style="color: #007bff; text-decoration: none;"
                               title="Редактировать">
...
function deletePost(postId) {
    if (confirm('Вы уверены, что хотите удалить эту статью?')) {
        ...
        window.location.href = '/admin/content/posts.php?action=delete&id=' + postId;
    }
}
</script>
