    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <div class="nav-section">
                ...
                <a href="/admin/admin-backup-tool.php" class="nav-item">
                    <span class="nav-icon">💾</span>
                    База данных
                </a>
            </div>
            ...
            <div class="nav-section">
                ...
                <a href="/admin/content/news.php" class="nav-item">
                    <span class="nav-icon">📰</span>
                ...
                <a href="/admin/content/posts.php" class="nav-item">
                    <span class="nav-icon">📋</span>
                    Управление постами
                ...
                <a href="/admin/content/create.php?type=news" class="nav-item <?= $contentType === 'news' ? 'active' : '' ?>">
                    <span class="nav-icon">➕</span>
                    Создать новость
                </a>
                <a href="/admin/content/create.php?type=post" class="nav-item <?= $contentType === 'post' ? 'active' : '' ?>">
                    <span class="nav-icon">📝</span>
                    Создать пост
                </a>
                ...
                <div class="user-menu" id="userMenu">
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="/admin/content/create.php?type=news" class="dropdown-item">
                                <span class="dropdown-icon">📰</span>
                                Создать новость
                            </a>
                            <a href="/admin/content/create.php?type=post" class="dropdown-item">
                                <span class="dropdown-icon">📝</span>
                                Создать пост
                            </a>
            ...
            <div class="form-card">
                <div class="form-card-header">
                    <h2 class="form-card-title">
                        <?= $contentType === 'news' ? '✏️ Редактировать новость' : '✏️ Редактировать пост' ?>
                    </h2>
                </div>
                
                <div class="form-card-body">
                    <form action="/admin/edit-process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-input" required 
                                   value="<?= htmlspecialchars($contentType === 'news' ? $item['title_news'] : $item['title_post']) ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-input" rows="3" required
                                      placeholder="Краткое описание для превью..."><?= htmlspecialchars($contentType === 'news' ? $item['description_news'] : $item['description_post']) ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="news_type" name="news_type" class="form-select">
                                <option value="education" <?= $item['category_news'] === 'education' ? 'selected' : '' ?>>Образование</option>
                                <option value="vpo" <?= $item['category_news'] === 'vpo' ? 'selected' : '' ?>>ВУЗы</option>
                                <option value="spo" <?= $item['category_news'] === 'spo' ? 'selected' : '' ?>>СПО</option>
                                <option value="school" <?= $item['category_news'] === 'school' ? 'selected' : '' ?>>Школы</option>
                                <option value="general" <?= $item['category_news'] === 'general' ? 'selected' : '' ?>>Общие</option>
                            </select>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                            $currentImage = null;
                            if ($contentType === 'news' && !empty($item['image_news'])) {
                                $currentImage = $item['image_news'];
                            } elseif ($contentType === 'post' && !empty($item['image_post'])) {
                                $currentImage = $item['image_post'];
                            }
                            ?>
                            <?php if ($currentImage): ?>
                            <div style="margin-bottom: 10px;">
                                <p style="color: var(--secondary); font-size: 0.875rem;">Текущее изображение:</p>
                                <img src="<?= htmlspecialchars($currentImage) ?>" alt="Current image" style="max-width: 200px; max-height: 150px; border-radius: 8px; box-shadow: var(--shadow);">
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-select">
                                <?php if ($contentType === 'news'): ?>
                                <option value="published" <?= $item['approved'] == 1 ? 'selected' : '' ?>>Опубликовано</option>
                                <option value="draft" <?= $item['approved'] == 0 ? 'selected' : '' ?>>Черновик</option>
                                <?php else: ?>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="<?= $contentType === 'news' ? '/dashboard/news' : '/dashboard/posts' ?>" class="btn btn-secondary">
                                ❌ Отмена
                            </a>
                        </div>
                    </form>
