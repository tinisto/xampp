...
<div class="news-header">
    ...
    <a href="/admin/content/create.php?type=news" class="btn-primary">
...
<form method="GET" class="filters-row">
    ...
    <?php if ($search || $statusFilter): ?>
        <a href="/admin/content/news.php" class="btn-primary" style="background: #6c757d;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <a href="/admin/content/edit.php?type=news&id=<?= $newsItem['id'] ?>" 
