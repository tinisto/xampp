#!/usr/bin/env python3
"""Fix tests page to show actual tests or fallback content"""
...
# Updated tests page with better query and fallback
tests_page_content = '''<?php
/**
...
try:
    print("Fixing tests page...")
    ftp = ftplib.FTP(FTP_HOST)
    ftp.login(FTP_USER, FTP_PASS)
    ftp.cwd(FTP_PATH)
    
    # Save and upload the fixed tests page
    with open('tests-main-real-fixed.php', 'w') as f:
        f.write(tests_page_content)
    
    with open('tests-main-real-fixed.php', 'rb') as f:
        ftp.storbinary('STOR pages/tests/tests-main-real.php', f)
    
    print("✓ Fixed tests page with fallback content")
    
    ftp.quit()
    
    print("\n✅ Tests page fixed!")
    print("\nThe page will now show:")
    print("1. Real tests from database if available")
    print("2. Sample/demo tests if no real tests found")
    print("3. Notice when showing demo tests")
    print("\nTest: https://11klassniki.ru/tests")
