...
if (!empty($search)) {
    ...
    $searchCondition = "WHERE (name_university LIKE '$searchLike' OR abbr_university LIKE '$searchLike')";
}
...
<div style="padding: 20px;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <div style="display: flex; gap: 20px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="/dashboard/vpo/new" class="action-btn primary">
                ...
                <tr style="border-bottom: 1px solid #dee2e6;">
                    ...
                    <td style="padding: 15px;">
                        <div style="display: flex; gap: 10px; justify-content: center;">
                            <a href="/dashboard/vpo/edit/<?= $uni['id_university'] ?>" 
...
function deleteVPO(uniId) {
    if (confirm('Вы уверены, что хотите удалить этот ВУЗ?')) {
        ...
        window.location.href = '/dashboard/vpo/delete/' + uniId;
    }
}
</script>
