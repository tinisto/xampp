        ...
        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
            <a href="/posts" 
               ...
               style="padding: 8px 16px; border-radius: 20px; text-decoration: none; transition: all 0.3s;
                      <?= !$categorySlug ? 'background: #0072ff; color: white;' : 'background: #f8f9fa; color: #495057;' ?>">
                Все статьи
            </a>
            ...
            <a href="/posts?category=<?= htmlspecialchars($cat['url_slug']) ?>" 
               ...
               style="padding: 8px 16px; border-radius: 20px; text-decoration: none; transition: all 0.3s;
                      <?= $categorySlug === $cat['url_slug'] ? 'background: #0072ff; color: white;' : 'background: #f8f9fa; color: #495057;' ?>">
                <?= htmlspecialchars($cat['category_name']) ?> 
                <span style="opacity: 0.7;">(<?= $cat['posts_count'] ?>)</span>
            </a>
            <?php endif; ?>
            <?php endforeach; ?>
        </div>
