                    ...
                    <div class="dashboard-card-body">
                        <div class="row">
                            <div class="col-md-3 mb-2">
                                <a href="#" class="dashboard-btn dashboard-btn-primary w-100">
                                    <i class="fas fa-plus"></i>Add School
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
                                <a href="#" class="dashboard-btn dashboard-btn-success w-100">
                                    <i class="fas fa-plus"></i>Add University
                                </a>
                            </div>
                            <div class="col-md-3 mb-2">
                                <a href="#" class="dashboard-btn dashboard-btn-outline w-100">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="alert alert-info">
                    ...
                    <strong>Dashboard Demo:</strong> This is a preview of the improved dashboard design. The real dashboard requires admin authentication.
                </div>
            </div>
        </div>
    </div>
