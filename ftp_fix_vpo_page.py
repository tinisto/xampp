...
def main():
    ...
    files_to_upload = [
        # Fix for VPO/SPO pages - correct table names
    ...
    try:
        ...
        if success_count == len(files_to_upload):
            ...
            print("\nWhat's fixed:")
            print("   ✅ /vpo-all-regions - Fixed table name from 'universities' to 'vpo'")
            print("   ✅ /spo-all-regions - Fixed table name from 'colleges' to 'spo'")
            print("   ✅ Both pages should now display content properly")
