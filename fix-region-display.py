#!/usr/bin/env python3
"""Fix region display to show proper region titles instead of numbers"""
...
# Updated educational institutions page with proper region handling
edu_page_content = '''<?php
/**
...
try:
    print("Fixing region display...")
    ftp = ftplib.FTP(FTP_HOST)
    ftp.login(FTP_USER, FTP_PASS)
    ftp.cwd(FTP_PATH)
    
    # Save and upload the fixed educational institutions page
    with open('educational-institutions-all-regions-real-fixed2.php', 'w') as f:
        f.write(edu_page_content)
    
    with open('educational-institutions-all-regions-real-fixed2.php', 'rb') as f:
        ftp.storbinary('STOR pages/common/educational-institutions-all-regions/educational-institutions-all-regions-real.php', f)
    
    print("✓ Fixed educational institutions page with proper region names")
    
    ftp.quit()
    
    print("\n✅ Region display fixed!")
    print("\nThe pages will now show proper region names instead of numbers:")
    ...
    print("\nRegions will show as text (e.g., 'Москва', 'Санкт-Петербург') instead of '1'")
