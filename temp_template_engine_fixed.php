    ...
    <style>
        ...
        * {
        ...
        .content {
            ...
            padding: 0; /* No padding - cards stick to edges */
        ...
        /* Desktop - larger margins but no padding */
...
<body>
    ...
    <div class="yellow-bg-wrapper">
        ...
        <main class="content" style="display: flex; flex-direction: column;">
            <!-- First grey div - cards go directly here as grid -->
            <div class="homepage-cards-grid" style="background: grey; border: 2px solid black; flex: 1; margin: 0; display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; padding: 0;">
                <?php echo $content; ?>
            </div>
            
            <!-- Second grey div - additional content area -->
            <div style="background: grey; border: 2px solid black; flex: 1; margin: 0;">
